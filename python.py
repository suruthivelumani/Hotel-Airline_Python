...
class InternationalFlight(Flight):
    ...
    def display_flight_details(self):
        ...
        file.write("Flight Name: " + self.fname + "\n")
        file.write("Flight Type: " + str(self.ftype) + "\n")
        file.write("Departure: " + self.fdept + "\n")
        file.write("Duration: " + self.fdur + "\n")
        file.write("Class: " + self.fclass + "\n")
        file.write("Number of Tickets: " + str(self.nooftickets) + "\n")
        file.write("Total Price: " + str(self.fbill) + "\n\n\n")
        file.close()'''
        ...
        '''file= open('flight_details.txt', 'w')
        file.write("Flight Details:\n")
        file.write("Flight Name: {}\n".format(self.fname))
        file.write("Flight Type: {}\n".format(self.ftype))
        file.write("Departure: {}\n".format(self.fdept))
        file.write("Duration: {}\n".format(self.fdur))
        file.write("Class: {}\n".format(self.fclass))
        file.write("Number of Tickets: {}\n".format(self.nooftickets))
        ...
        Class: {}
        Number of Tickets: {}
        Total Price: {}""".format(self.fname, self.ftype, self.fdept, self.fdur, self.fclass, self.nooftickets, self.fbill)
        file=open('flight_details.txt', 'w')
        file.write(content)'''
